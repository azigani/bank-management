package com.alphonse.bankback.batch;
...
public class ExportTraceDataBatchConfig {
    ...
    public Job exportTraceData() throws Exception {
        ...
        return this.jobBuilderFactory.get("exportTraceData")
                ...
                .next(cleanTraceDataStep())//suppression ces traces après export de notre job
                .build();
    }

	/**
	 * Export des traceData
	 * @return
	 * @throws Exception
	 */
	@Bean
    public Step exportTraceDataStep() throws Exception {
    	...
    	//uilisation de tasklet pour les lectures de données
